...
public:
	...
	//----------------------------------------------------------------------
	using	POSITION_NODE_TYPE = POSITION_NODE<Type>;
	using	POSITION_LIST	   = std::list<POSITION_NODE_TYPE>;
...
public:
	...
	auto	GetIterator() const { return m_listPosition.begin(); }
...
CPositionList<Type>::Add(Type x, Type y)
{
	...
	auto iPosition = m_listPosition.begin();
