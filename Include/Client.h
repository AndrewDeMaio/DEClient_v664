...
#define PROGRAM_NAME                "DarkOnline"
#else//__IMI_INTERFACE
#define PROGRAM_NAME                "DarkEden"
#endif //__IMI_INTERFACE

#if __CONTENTS(__IMI_INTERFACE)
#define PROGRAM_TITLE                "DarkOnline"
#else//__IMI_INTERFACE
#define PROGRAM_TITLE                "DarkEden"
#endif //__IMI_INTERFACE
...
//(!) RPK_PASSWORD define�� VS_UI_filepath.h���� ����
...
// 100 --> 10 Frame
// 111 --> 9 Frame
#define	LIMIT_FPS_FOR_CURSOR	24		// �ε巯��(?) Ŀ�� ����� ���� �ּ�FPS
...
extern BOOL					g_bNeedUpdate; // update�ؾߵǳ�?
...
extern bool					g_bPutMessage;		// ȭ�鿡 debug�޼����� ����ұ�?
	
extern bool					g_bNewDraw;			// ȭ���� �ٽ� �׷ȴ°�? (Ŀ�� ����)
extern bool					g_bSmoothCursor;	// �ε巯��(?) cursor�� ����� �� �ֳ�?
extern bool					g_bNetStatusGood;	// ��Ʈ�� ���°� ������?
