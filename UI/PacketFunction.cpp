...
#include "GPackets\GCAddItemToZone.h"
...
#if __CONTENTS(__FAST_TRANSFORTER||__SECOND_TRANSFORTER)
		//����, �����̾��� �ű��̵������̶��..... 
		//4�� 30�� �׼� / 5�� 7�� ���� ��ġ������ ���Ƿ� Color���� 0���� �����Ѵ�.
		//����, �ű��̵����ܿ� ���� Color Enchant����� �߰��� ��.. (����)�����̾� ����ũ�� ���ؼ� Coloró���� ������ �κ��� �����ϰ�, �� ���� �� �κ��� ó���� ������ �ϳ�.
#if __CONTENTS(__FAST_TRANSFORTER)
...
//--------------------------------------------------------------------------------
#if __CONTENTS(__GEAR_SWAP_CHANGE) // SetGearInfo ��ü
...
#if __CONTENTS(__GEAR_SWAP_CHANGE) // ��ü�� �Ǿ����� �˸���.
...
#if __CONTENTS(__GEAR_SWAP_CHANGE) // SetGearInfo ���� �� �� ���� �������� UnSet�Ѵ�.
...
#if __CONTENTS(__GEAR_SWAP_CHANGE) // SetGearInfo �������� ���� ����â�� ID�� ���� �Ѵ�.
	switch(g_pPlayer->GetRace())
	{
	case RACE_SLAYER:
...
#if __CONTENTS(__GEAR_SWAP_CHANGE) // ��ü�� �Ϸ� �Ǿ����� �˸���.
	switch(g_pPlayer->GetRace())
	{
	case RACE_SLAYER:
		...
		{			
			...
			*/
			...
			if(pItem->GetItemClass() == ITEM_CLASS_DYE_POTION )
			{
				...
				//���� ������ ����Ʈ �÷� ����
				//23�׸�, 2����, 33����, 82����, 380ȭ��Ʈ, 50��ī�̺���, 151���϶�, 395����, 0xFFFF�⺻
		...
		else
		{
			...
			if(pItem != NULL)
			{
...
#if __CONTENTS(__PET_VISION_AMPLE)
				// isSummonInfo�� 1�̸� ��ȯ����Ʈ �� ��ȯ �޼��� �Ѹ�
				// ���� isSummonInfo�� 2�϶� ũ���Ĵ� �����ǰ�, ��ȯ�� �޽����� ����
				...
				if(pCreature->GetPetID() != OBJECTID_NULL)
				{
					...
					if(oldCreatureType < g_pCreatureTable->GetSize())
					{	
						CREATURETABLE_INFO &old_creatureInfo = g_pCreatureTable->Get(oldCreatureType);				
						
						if(old_creatureInfo.EffectSpriteType != MAX_EFFECTSPRITETYPE)
						{
							pFakeCreature->RemoveAttachEffect(old_creatureInfo.EffectSpriteType);
						}	
					}
					//------------------------------------------------------------------------------
...
//					pItem->SetPetExpRemain( pPetInfo->getPetExp() );
					...
					{
						pItem->AddItemOption(pPetInfo->getPetOption());		// ���� ����� ��þƮ�� �ɼ�
#if __CONTENTS(__PET_VISION_AMPLE)
					...
					{
						pItem->AddItemOption(pPetInfo->getPetOption2());	// �������÷� ��þƮ�� �ɼ�
						pItem->SetPet_AmpulOptionNum(pPetInfo->getPetOption2());
					}
#endif //__PET_VISION_AMPLE
					
#if __CONTENTS(__NEW_PET_INCUBUS)
					// 081203 wlzzi - OptionType�߰�
					// 2008-12-09 - ij-ch
					// 12�� ���������(��ť����)������ �⺻�ɼ����� ���� �ɼ�
					// Ŭ���̾�Ʈ�� UI�󿡼��� ���� list<TYPE_ITEM_OPTION>������ �ɼ��� ADD()����������
					// �����󿡼��� �� �ɼǰ� �����ۿɼ��� �������� �ִ�.
...
//20081007 petType���� �Ʒ��ʿ� �ִ��� ���ּ��� ���� ���ؼ� ���� �ø�
					...
					if(enchantSkillType >= 0)
					{
						...
						switch(petType)
						{
						case 1: case 2: case 6: case 9: // ������, �����, ����, ���̾����Ż
...
//20081002 ���ϳ��� �ϵ��ڵ�? ��ư �꿡 Ŭ���̾�Ʈ ���� EFFECTSTATUS�� �ٿ��� �꿡 ������ ����Ʈ�� �ٿ��� �����ش�.
//Ÿ�ε� �����ֱ� ���ؼ� ���⼭ �ٿ���� �Ѵ�.
//�̷� ������ ����Ʈ �ٴ� ĳ�̽��� �þ�� case������ ���� �ص� ������
#if __CONTENTS(__2008_OCTOBER_MAKETITEM)
					if(petType == 10)
					...
					if(pPetInfo->getPetCreatureType() < g_pCreatureTable->GetSize())
					{
						...
						{
							pFakeCreature->AddEffectStatus((EFFECTSTATUS)creatureInfo.EffectStatus, 0xFFFF);
						}
						
						if(creatureInfo.EffectSpriteType != MAX_EFFECTSPRITETYPE)
						{
							//if(pFakeCreature->GetAttachEffectIterator())
							
							pFakeCreature->RemoveAttachEffect(EFFECTSPRITETYPE_UPGRADED_CARA_CATS_EFFECT_FRONT);
							pFakeCreature->CreateAttachEffect((ENUM_EFFECTSPRITETYPE)creatureInfo.EffectSpriteType, 0xFFFF, 0);
						}
					}
