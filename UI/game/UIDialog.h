...
class UIDialog {
	...
	public :
		...
		// PC Talk Dlg
		//---------------------------------------------------------
		void			PopupPCTalkDlg(int x=-1, int y=-1);		// -1�� center�� �ǹ��Ѵ�.(default)
		void			HidePCTalkDlg();
		void			ShowPCTalkDlg();
		...
		// Message Dlg
		//---------------------------------------------------------
		//void			PopupMessageDlg(UIDIALOG_MESSAGE msg, int x=-1, int y=-1);		// -1�� center�� �ǹ��Ѵ�.(default)		
		void			PopupFreeMessageDlg(const char* msg, int x=-1, int y=-1, WORD fButton = UI_DIALOG_OK, bool IsAfterExit = false);		// -1�� center�� �ǹ��Ѵ�.(default)				
		...
		void			PopupFreeMessageAndItemDlg(const char* msg, int Item_FrameID, int x=-1, int y=-1, WORD fButton = UI_DIALOG_OK, bool IsAfterExit = false);		// -1�� center�� �ǹ��Ѵ�.(default)
#endif //__DYNAMIC_UI

		//---------------------------------------------------------
		// Message Dlg
		//---------------------------------------------------------
		//void			PopupHelpDlg(int x=-1, int y=-1);		// -1�� center�� �ǹ��Ѵ�.(default)		
		//static void		ProcessHelpDlg(C_VS_UI_DIALOG * pDlg, unsigned long id);
		//void			CloseHelpDlg();

	protected :
		static DWORD	s_LockGameInput;	// client���� �Է��� ���´�.
	...
	public :
		...
		void				PopupAddonSelectDlg(int x=-1, int y=-1);		// -1�� center�� �ǹ��Ѵ�.(default)
		static void			ProcessAddonSelectDlg(C_VS_UI_DIALOG * pDlg, unsigned long id);

		void				PopupActionSelectDlg(int x=-1, int y=-1);		// -1�� center�� �ǹ��Ѵ�.(default)
		static void			ProcessActionSelectDlg(C_VS_UI_DIALOG * pDlg, unsigned long id);

		void				PopupDirectionSelectDlg(int x=-1, int y=-1);		// -1�� center�� �ǹ��Ѵ�.(default)
