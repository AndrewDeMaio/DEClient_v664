...
//	(*g_pGameStringTable)[STRING_MESSAGE_ITEM_NOT_EXIST] = "지정한 위치에 아이템이 존재 하지 않습니다.";// GCShopBuyFailHandler에러 문구 추가 (2008.08.26) shootkj
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_MENU] = "정보";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_EXP] = "커뮤니티";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM] = "팀";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_MESSAGE] = "상점";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_HELP] = "도움말";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_INVENTORY] = "아이템창";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GEAR_WINDOW] = "장착창";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_INFO_WINDOW] = "정보창";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_PARTY_WINDOW] = "파티창";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_QUEST_WINDOW] = "퀘스트";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM_INFO] = "팀 정보";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM_MEMBER_LIST] = "팀원 리스트";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLAN] = "클랜";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLAN_INFO] = "클랜 정보";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLAN_MEMBER_LIST] = "클랜원 리스트";
...
//	(*g_pGameStringTable)[UI_STRING_MESSAGE_EVENT_QUEST_5] = "5.아우스터즈와의 조우\\n목적:아우스터즈를 부활시킬 정령석 찾기";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GUILD] = "길드";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GUILD_INFO] = "길드 정보";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GUILD_MEMBER_LIST] = "길드원 리스트";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_MAILBOX] = "편지함";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_SMS_WINDOW] = "SMS창";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_NAMING_WINDOW] = "닉네임창";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM_COMMAND_WINDOW] = "팀 명령";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM_LIST_WINDOW] = "팀 목록";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM_WAIT_LIST_WINDOW] = "대기 팀 목록";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_TEAM_UNION_WINDOW] = "팀 연합";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLAN_COMMAND_WINDOW] = "클랜 명령";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLAN_LIST_WINDOW] = "클랜 목록";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLAN_WAIT_LIST_WINDOW] = "대기 클랜 목록";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_CLAN_UNION_WINDOW] = "클랜 연합";

	(*g_pGameStringTable)[UI_STRING_MESSAGE_GUILD_COMMAND_WINDOW] = "길드 명령";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GUILD_LIST_WINDOW] = "길드 목록";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GUILD_WAIT_LIST_WINDOW] = "대기 길드 목록";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_GUILD_UNION_WINDOW] = "길드 연합";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_UTIL] = "기능";
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_WORLD_MAP]					= "전체 지도";
...
//#endif
	...
	(*g_pGameStringTable)[UI_STRING_MESSAGE_OUSTERS_CONTRIBUTENAME_3]="이블리스";
...
//#if__TITLE_UI_RENWEAL
	...
	//아우스터즈 봉인.
	(*g_pGameStringTable)[UI_TITLE_UI_RENEWAL_CREATECHAR_TEXT2] = "새로운 슬레이어/뱀파이어를 생성 합니다.";	// 2종족.
	(*g_pGameStringTable)[UI_TITLE_UI_RENEWAL_CREATECHAR_TEXT3] = "캐릭터의 이름, 성별, 얼굴, 색상 등을 결정하신 후 재설정 버튼으로 캐릭터의 능력치를 설정하세요.";
	(*g_pGameStringTable)[UI_TITLE_UI_RENEWAL_CREATECHAR_TEXT4] = "저장하기/불러오기 버튼으로 능력치를 저장하고 불러올 수 있습니다. 뱀파이어의 경우는 머리색과 능력치를 선택 할 수 없습니다.";
	(*g_pGameStringTable)[UI_TITLE_UI_RENEWAL_CREATECHAR_TEXT5] = "아우스터즈의 경우는 성별과 피부색을 선택 할 수 없고 능력치는 직접 선택하여 올리실 수 있습니다.";
...
//#if __CONTENTS(__IMI_NEW_ENCHANT_ITEM)
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ENCHANT_DELETE_DEFENSE]						= "리타드 옐로우 코어로 인해 아이템 파괴 방지에 성공했습니다.";
	(*g_pGameStringTable)[UI_STRING_MESSAGE_ENCHANT_THIRDOPTION_PENALTY_DEFENSE]		= "리타드 릴리스 코어로 인해 릴리스 옵션 유지에 성공했습니다.";
//endif //__IMI_NEW_ENCHANT_ITEM
//#if __CONTENTS(__IMI_MIXNGFORGE)
	(*g_pGameStringTable)[UI_STRING_MESSAGE_MIXING_FORGE_FAIL]				= "아이템 믹싱에 실패 했습니다.";
//#endif //__IMI_MIXNGFORGE	

	(*g_pGameStringTable)[UI_STRING_MESSAGE_PET_FOOD_WARN]					= "먹이를 먹게되면 기존 먹이의 효과는 모두 사라집니다.";
