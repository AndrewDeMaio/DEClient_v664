...
public:
	...
	void	SetMessage(std::string* sz_msg, UINT line_count, SETMESSAGE_MODE_OPTION mode=SMO_FIT , int nLineCheck = LINECHECK_NO_USE, int iMsgWidth = 0);
