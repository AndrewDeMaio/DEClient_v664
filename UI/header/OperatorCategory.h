...
// 자동 QA 기능
//-----------------------------------------------------------------------------
//#include "AQA_Report.h"		//by kim
//#include "AutoQAFunctions.h"	//by kim

class COperatorCategoryAutoQA: public COperatorCategory/*by kim, public aqa::Report*/
{
public:
	enum EXEC_ID
	{
...
public:
			COperatorCategoryAutoQA(LPCTSTR categoryName, Window* parentWindow, const CRect& position);
			~COperatorCategoryAutoQA();
...
public:
	...
	// Auto QA Report
public:
//by kim	virtual void AddUnit(const aqa::ReportUnit& unit);
...
private:
	...
	C_VS_UI_LISTBOX	*m_pWorkListBox;
	C_VS_UI_LISTBOX	*m_pReportListBox;

	STRING_LIST		m_WorkStringList;
	STRING_LIST		m_ReportStringList;

	bool			m_bWorking;

//	AQAFunctions	m_AQAFunctions;	//by kim
};
