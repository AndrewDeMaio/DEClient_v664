...
void C_VS_UI_SHOP::StartBuyConfirmDialog(int _x, int _y, int num)
{
	...
	if (selected_item != NULL)
	{
		...
		else
		{
			...
			static std::string pp_dmsg_buy_confirm[] = {(*g_pGameStringTable)[UI_STRING_MESSAGE_BUY_ITEM].GetString()};
