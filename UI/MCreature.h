...
//이 마스터 타입은 마켓 타입을 말한다.
		...
		// 파티 체크
		//--------------------------------------------------
		bool				IsPlayerParty() const		{ return m_bPlayerParty && !m_bHallu; }	// 할루가 걸려있으면 파티 아님
...
//테스트 코드
	...
	protected :
		...
		COLORREF				m_ColorPersonalShop;		// 상점 채팅 색
