...
void CI_JAPAN::IME_MessageProcessor(UINT message, WPARAM wParam, LPARAM lParam)///
{
	...
	case WM_IME_COMPOSITION:
		...
		else	if (lParam & GCS_COMPSTR)
		{
			...
			if (iBeforeLen > len)
			{
				strcpy_s(m_composing_string, sizeof(m_composing_string), m_Before_composing_string);
			...
			if (len > 0)
			{
				...
				strcpy_s(m_Before_composing_string, sizeof(m_Before_composing_string), m_composing_string);
				memset(m_composing_string, 0, sizeof(m_composing_string));
