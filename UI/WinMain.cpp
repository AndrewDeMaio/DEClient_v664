...
-
  ...
  dw_left�� dw_right�� LOWORD, HIWORD�� �˻��� �� �ִ�. WORD������ ���� ����
  �׷������� ���´�.
  ���� DWORD�� ���̶�� �װ��� ������� �ʴ´�.
-----------------------------------------------------------------------------*/
void UI_ResultReceiver(DWORD message, int dw_left, int dw_right, void* void_ptr)
{
	...
	case UI_JOIN_READY_TEAM:
		gC_vs_ui.RunTeamRegist(true, 100000, 1, "2002-01-01", "Back", 100);
		break;

	case UI_JOIN_REGIST_TEAM:
		gC_vs_ui.RunTeamRegist(true, 100000, 2, "2002-01-01", "Back", 100);
		break;
	...
	case UI_MESSAGE_BOX:
		...
		case STRING_MESSAGE_CANNOT_REPAIR:
			MessageBox(NULL, "����... �̰� ���� Ŭ���̾�Ʈ�����ۿ� ������ ���̾˷α׶� �̷��� ���!\r\n������ ���о� ���ؿ�!", "-_-; ���ӻ� ����� ������ ���̾˷α׹ڽ�", MB_OK);
			break;
		}
		break;
	...
	case UI_REQUEST_GUILD_MEMBER_LIST:
	{
		...
		member_info.MEMBER_NAME = "�����ٶ󸶹�";
		member_info.SERVER_NAME = "�ƹٷν�(pk����)";
	...
	case UI_CLOSE_COMPUTER: // by larosel
		...
		//			
		//			int arms = dw_left;	// 0: �� 1: �� 2: ���̽� 3: ���ڰ� 4: AR 5: TR 6: SMG 7:SG
		//		}
		//		break;
	...
	case UI_INFO:
		...
		else
		{
			...
			g_char_slot_ingame.sz_guild_name = "";//�帲�����Ͷ�ϱ�";
	...
	case UI_CHECK_EXIST_ID:
		...
		/*
				...
				case UI_PLEASE_PCS_CONNECT_ME: // ���� click! (�̹� ����-duplex-���� �ʾ���)
					//
					// ����� �ִ� ������ Ŭ���Ͽ���. (�޽����� �۽� �ϱ� ���ؼ�)
					//
					// left = pcs number
				...
				//	break;
		*/
	case UI_CHAT_RETURN: // ä��â �Է� // by larosel

		//			if (dw_right)
		//			{
		//				gC_vs_ui.AddChatToHistory((char *)void_ptr, "��ũ����", CLD_NORMAL, true);	// ���ä��
		//			}
		//			else
	{
		gC_vs_ui.AddChatToHistory((char*)void_ptr, "Reward received.", (CHAT_LINE_CONDITION)dw_left, dw_right);
	}
	...
	case UI_GAMEMENU_CONTINUE:
		...
		break;
		/*
				case UI_END_PCS: // PCS â���� PCS number�� send�ϰ� connecting �߿� END�� ������.
					break;
				...
				case UI_SEND_PCS_NUMBER:
					...
					// �����ϱ⸦ ���ϴ� pcs number�� ������ ��������� �Ѵ�.
					//
					gC_vs_ui.OnLinePCS(NULL, dw_left); // ���Ἲ��
	...
	case UI_CHARACTER_MANAGER_FINISHED:
		...
		{
			gC_vs_ui.StartServerSelect(false);
			std::string server_name[20] = { "���ϼ�", "��â��", "���ϼ�", "����", "����", "�鼷", "�鼷", "�鼷", "�鼷", "�鼷", "�鼷", "�鼷", "�鼷", "�鼷", "�鼷", "�鼷", "�鼷", "�鼷", "�鼷", "����" };
	...
	case UI_ITEM_DROP_TO_GEAR:
	{
		...
		//
		//				{
		//					if (g_pOustersGear->ReplaceItem(pMouseItem,		// �߰��� item
		//						dw_left,	// �߰��� ��ġ 
		//						pOldItem))		// �����ִ� item
		//					{
		...
		{
		case RACE_SLAYER:
			if (g_pSlayerGear->ReplaceItem(pMouseItem,		// �߰��� item
				dw_left,	// �߰��� ��ġ 
				pOldItem))		// �����ִ� item
			{
				if (pOldItem != NULL) // replace �Ǿ��°�?
		...
		case RACE_VAMPIRE:
			if (g_pVampireGear->ReplaceItem(pMouseItem,		// �߰��� item
				dw_left,	// �߰��� ��ġ 
				pOldItem))		// �����ִ� item
			{
				if (pOldItem != NULL) // replace �Ǿ��°�?
	...
	case UI_ITEM_DROP_TO_QUICKSLOT:
	{
		...
		if (g_eRaceInterface == RACE_OUSTERS)
		{
			...
			if (g_pQuickSlot->ReplaceItem(pMouseItem,		// �߰��� item
				dw_left, pOldItem))		// �����ִ� item
			{
				if (pOldItem != NULL) // replace �Ǿ��°�?
				{
					gC_vs_ui.PickUpItem(pOldItem);
	...
	case UI_ITEM_PICKUP_FROM_GEAR:
		...
		{
		case RACE_SLAYER:
			g_pSlayerGear->RemoveItem((MSlayerGear::GEAR_SLAYER)dw_left);		// �����ִ� item
			break;
	...
	case UI_LOGIN:
	{
		...
		std::string group_name[5] = { "�׷�1", "�׷�2", "�׷�3", "�׷�4", "�׷�5" };
