...
struct DrawNameCreatureInfo
{
	DrawNameCreatureInfo()
		: pCreature(NULL), bOverText(false) {
		ptDrawPostion.x = ptDrawPostion.y = 0;
	}
...
public:
	...
	CShadowSpriteTypePack	m_EffectShadowSPK;		// ShadowSprite들
	...
	CShadowSpriteTypePack		m_AddonManSSPK;			// Sprite들	
	CShadowSpriteTypePack		m_AddonWomanSSPK;		// 

	CShadowSpriteTypePack		m_CreatureSSPK;
	//#if __CONTENTS(__ONIBLA)
	CShadowSpriteTypePack		m_CreatureSSPK2;
	//#endif //__ONIBLA
	CShadowSpriteTypePack		m_OustersSSPK;
	CShadowSpriteTypePack		m_VampireSSPK;
