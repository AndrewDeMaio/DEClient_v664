...
C_VS_UI_DIALOG *		g_msg_wrong_delete;
...
void g_InitMessage()
{
	...
	static std::string pp_dmsg_not_available_menu[] ={(*g_pGameStringTable)[UI_STRING_MESSAGE_NOT_SUPPORT_MENU].GetString()};
	...
	static std::string pp_dmsg_wrong_id_password[] ={ (*g_pGameStringTable)[UI_STRING_MESSAGE_NOT_INPUT_ID_OR_PASSWORD].GetString()};
	...
	static std::string pp_dmsg_invalid_id_password[] ={ (*g_pGameStringTable)[STRING_ERROR_INVALID_ID_PASSWORD].GetString()};
	...
	static std::string pp_dmsg_wrong_ssn[] ={(*g_pGameStringTable)[UI_STRING_MESSAGE_WRONG_SSN].GetString()};
	...
	static std::string pp_dmsg_wrong__delete[] ={(*g_pGameStringTable)[STRING_ERROR_INVALID_DELETE].GetString()};
	...
	static std::string pp_dmsg_invalid_ssn[] ={(*g_pGameStringTable)[STRING_ERROR_INVALID_SSN].GetString()};
	...
	static std::string pp_dmsg_empty_name[] ={(*g_pGameStringTable)[UI_STRING_MESSAGE_INPUT_NAME].GetString()};
	...
	static std::string pp_dmsg_left_bonus_point[] ={(*g_pGameStringTable)[UI_STRING_MESSAGE_LEFT_BONUS_POINT].GetString()};
...
//	g_msg_server_disconnect->SetMessage(pp_dmsg_server_disconnect, 1, SMO_NOFIT);
	...
	static std::string pp_dmsg_server_connect_failed[] ={ (*g_pGameStringTable)[UI_STRING_MESSAGE_CANNOT_CONNECT_SERVER].GetString()};
	...
	static std::string pp_dmsg_not_select_char[] ={(*g_pGameStringTable)[UI_STRING_MESSAGE_SELECT_CHARACTER].GetString()};
	...
	static std::string pp_dmsg_char_delete_completed[] ={ (*g_pGameStringTable)[UI_STRING_MESSAGE_DELETE_CHARACTER].GetString()};
	...
	static std::string pp_dmsg_all_slot_not_char[] ={(*g_pGameStringTable)[UI_STRING_MESSAGE_ALL_SLOT_EMPTY].GetString()};
	...
	static std::string pp_dmsg_all_slot_created[] ={(*g_pGameStringTable)[UI_STRING_MESSAGE_NO_MORE_CREATE_CHARACTER].GetString()};
	...
	static std::string pp_dmsg_character_create_failed[] ={(*g_pGameStringTable)[UI_STRING_MESSAGE_FAIL_CREATE_CHARACTER].GetString()};
...
//	g_msg_character_empty_id->SetMessage(pp_dmsg_character_empty_id, 1, SMO_NOFIT);
	...
	static std::string pp_dmsg_new_user_not_completed[] ={ (*g_pGameStringTable)[UI_STRING_MESSAGE_NO_INPUT_NEED_INFO].GetString()};
	...
	static std::string pp_dmsg_id_aleady_exist[] ={(*g_pGameStringTable)[UI_STRING_MESSAGE_ALREADY_USE_ID].GetString()};
	...
	static std::string pp_dmsg_id_no_aleady_exist[] ={(*g_pGameStringTable)[UI_STRING_MESSAGE_CAN_USE_ID].GetString()};
	...
	static std::string pp_dmsg_password_mismatch[] ={(*g_pGameStringTable)[UI_STRING_MESSAGE_RE_INPUT_PASSWORD].GetString()};
