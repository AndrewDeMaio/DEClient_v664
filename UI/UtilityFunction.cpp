...
#if __CONTENTS(__KOREAN_UI) || __CONTENTS(__IMI_INTERFACE)
...
/*
			...
			// ����, ������ �ִ� ����� �߸��� ���̵��.
			//--------------------------------------------------------
			const char* badKor = "���������������������ˤŤ����¤ĤƤ����������Ǥä��Ӥ��������Ф̤ѤɤͤϤ�";
...
#if !__CONTENTS(__KOREA_UI) && !__CONTENTS(__IMI_INTERFACE)
...
// Get DiskFreeSpace
//-----------------------------------------------------------------------------
// Drive가 NULL이면 현재의 파일명이 있는 드라이브.
//-----------------------------------------------------------------------------
