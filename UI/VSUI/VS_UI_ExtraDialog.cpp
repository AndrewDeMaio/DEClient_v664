...
void	C_VS_UI_MONEY_DIALOG::KeyboardControl(UINT message, UINT key, long extra)
{
	...
	case MONEY_CAMPAIGN_HELP:
		...
		break;
	case MONEY_WEDDING_CONTRIBUTION:			// ���Ǳ� �ִ� 100,000 ������ �ʴ´�.
		_MAX_MONEY = 10;
		break;
	...
	C_VS_UI_DIALOG(_x, _y, center_x, center_y, exec_fp, dd_button)
{
	...
	case ASK_REPAIRITEMALL:
		//������� ������ �ѵ��ݾ��� 20���� ������ ������? 10�� �ڸ��� ��� �Ѵ�. ���� 8<x<16�̱� ���� �����ϴ� �ּҰ� 16���� ����
		char temp[16];
...
void	C_VS_UI_NPC_DIALOG::Show()
{
	...
	C_VS_UI_DIALOG::SetTx(m_tx); // �θ�Ŭ�������� �����Ǵ� Ÿ���� ȿ��������
#endif //__DYNAMIC_UI
