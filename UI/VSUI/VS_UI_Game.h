...
//	void	AcquirePDSClosedMessage();
	...
	void	AddChatToHistory(char * str, const char * sz_id, CHAT_LINE_CONDITION condition, DWORD color);
...
//	void	RunTutorialExitAccept();
	...
	void	RunTeamRegist(bool member, int reg_fee, int rank, const char *date, const char *team_name = NULL, int guild_id = -1);
