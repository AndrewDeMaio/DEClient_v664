...
void C_VS_UI_VAMPIRE::HotKey_F1()
{
	...
	const MItem * p_item = g_pInventory->FindItem( ITEM_CLASS_SERUM ); // 혈청
	if(p_item == NULL)
		p_item = g_pInventory->FindItem( ITEM_CLASS_SERUM, 4 ); // 노란사탕 - 3종족 모두 사용가능
...
void C_VS_UI_VAMPIRE::HotKey_F2()
{
	...
	//const MItem * p_item = g_pInventory->FindItem( ITEM_CLASS_EVENT_ETC, 14 ); // 노란사탕 - 3종족 모두 사용가능
	const MItem * p_item = g_pInventory->FindItem( ITEM_CLASS_SERUM, 4 ); // 노란사탕 - 3종족 모두 사용가능
	if(p_item == NULL)
		p_item = g_pInventory->FindItem( ITEM_CLASS_SERUM ); // 혈청
