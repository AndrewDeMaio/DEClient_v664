...
public:
	...
	const char* GetFileName() { if (m_filename.empty())return nullptr; return m_filename.c_str(); }
...
//	};
	...
	std::string					m_sz_question_msg[MAX_MONEY_DIALOG_TYPE][1];		// by sigi
...
private:
	...
	std::string						m_sz_question_msg_temp[3];
	std::string						m_sz_question_msg[MAX_ASK_DIALOG_TYPE][16];
