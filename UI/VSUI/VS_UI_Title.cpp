...
//	m_pC_etc.Open(SPK_NEWCHARACTER_ETC);
	...
	//#ifdef CONVERT_1024_768// ���ο� ui�� �������� �Ʒ��� �ӽ��ڵ� ���� ���.
...
void C_VS_UI_NEWCHAR::Show()
{
	...
	//#ifdef CONVERT_1024_768 //convx,convy �����ڵ�� �ӽ��ڵ� �߰��Ѱ���. ui����� ���� ���
	//	int convx = 112, convy = 84;
	//#else
	//	int convx = 0 , convy = 0;
	//#endif
	...
	if (gpC_base->m_p_DDSurface_back->Lock())
	{
		...
		if (m_pC_use_grade != NULL && !g_pUserInformation->bChinese)
		{
			...
			//20070420 �߰� 12, 19�� ǥ�� �ȵǰ�... by diesirace
...
void C_VS_UI_CHAR_MANAGER::Show()
{
	...
	{
		ShowDesc(convx, convy);//�� ui�� ������ ������ �ӽ� �ڵ�
	}

	//#ifdef CONVERT_1024_768
	//		ShowDesc(112,84);//�� ui�� ������ ������ �ӽ� �ڵ�
	//#else
	//		ShowDesc();
	//#endif
...
//			else m_pC_symbol_ani.BltLocked(symbol_x, symbol_y);
			...
			if (m_pC_use_grade != NULL && !g_pUserInformation->bChinese)
			{
				...
				*//* -- Netmarble�� ���, �������ڷ� ������ ���̰��� �޾�, GoreLevel���� �ʱ�ȭ �� �� �����Ƿ�.. �α�â������ �̿�����UIǥ�ÿ� �ݿ��ؾ� �Ѵ�. --*/
				if (g_pUserInformation->IsNetmarble)
				{
					if (g_pUserInformation->GoreLevel)
					{
