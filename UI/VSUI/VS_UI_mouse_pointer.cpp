...
void	C_VS_UI_MOUSE_POINTER::SetCursorPortal(int zone_id, int x, int y, std::string owner_name)
{
...
void	C_VS_UI_MOUSE_POINTER::SetCursorPickUp(std::string str, COLORREF color)
{
	switch(g_eRaceInterface)
	{
	case RACE_SLAYER:
