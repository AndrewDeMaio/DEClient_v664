...
//	{
	m_slot_rect[SN_CIRCLET].Set(114, 62, 60, 60);			// 서클릿
	m_slot_rect[SN_COAT].Set(114, 165, 60, 90);				// 옷
	m_slot_rect[SN_LEFTHAND].Set(199, 165, 60, 90);			// 왼손
	m_slot_rect[SN_RIGHTHAND].Set(28, 165, 60, 90);			// 오른손
	m_slot_rect[SN_BOOTS].Set(114, 261, 60, 90);				// 신발
	m_slot_rect[SN_ARMSBAND1].Set(28, 100, 60, 60);			// 암스밴드1
	m_slot_rect[SN_ARMSBAND2].Set(199, 100, 60, 60);			// 암스밴드2
	...
	m_slot_rect[SN_NECK_CHAIN].Set(127, 128, 30, 30);		// 에테리얼 체인

	m_slot_rect[SN_CUEOFADAM1].Set(29, 269, 30, 30);		// 큐1
	m_slot_rect[SN_CUEOFADAM2].Set(230, 269, 30, 30);		// 큐2
...
//		g_Print(rect.left, rect.top, sz_temp, &gpC_base->m_item_desc_pi);	
	...
	// show hot-key
	const char * p_hotkey_mark[] = {"F1", "F2", "F3", "F4", "F5", "F6" , "F7" , "F8" , "F9" ,  "F10" , "F11" , "F12"};
