...
//----------------------------------------------------------------------
void	
CAlphaSpritePal::memcpyAlpha(WORD* pDest, BYTE* pSource, DWORD pixels, MPalette &pal)
{
	WORD sTemp,dTemp;
...
// pRect->top, rectBottom만큼만 출력한다.
//----------------------------------------------------------------------
void CAlphaSpritePal::Blt4444NotTransClipHeight(WORD *pDest, WORD pitch, RECT* pRect, MPalette &pal)
{
	int		count,
			transCount,
			colorCount;
