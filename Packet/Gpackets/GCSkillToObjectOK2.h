...
public :
   ...
   void write(SocketOutputStream & oStream) const;
	...
	// get packet id
	PacketID_t getPacketID() const { return PACKET_GC_SKILL_TO_OBJECT_OK_2; }

	// get packet's body size
	// ����ȭ��, �̸� ���� ������ ����Ѵ�.
	size_t getPacketSize() const { return szObjectID+ szSkillType + szDuration + szBYTE + szBYTE + ModifyInfo::getPacketSize(); }

	// get packet's name
	string getPacketName() const { return "GCSkillToObjectOK2"; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID() const { return Packet::PACKET_GC_SKILL_TO_OBJECT_OK_2; }

	// get Packet Max Size
	PacketSize_t getPacketMaxSize() const { return szObjectID+ szSkillType + szDuration + szBYTE + szBYTE + ModifyInfo::getPacketMaxSize(); }
};
