...
public :
	...
	// ����ȭ��, �̸� ���� ������ ����Ѵ�.
	size_t getPacketSize() const { return szCoord*2 + szSkillType + szDuration + szBYTE + szBYTE + ModifyInfo::getPacketSize(); }
...
public :
	...
	// get Packet Max Size
	PacketSize_t getPacketMaxSize() const { return szCoord*2+ szSkillType + szDuration + szBYTE + szBYTE + ModifyInfo::getPacketMaxSize(); }
};
