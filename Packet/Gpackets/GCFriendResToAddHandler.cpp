...
void GCFriendResToAddHandler::execute ( GCFriendResToAdd* pPacket, Player* pPlayer )
{
	...
	if (pPacket)
	{
		...
		{
		case FRIEND_RES_TO_ADD_RESULT_CODE_SUCCESS:												// ���� ��û ����
			break;
		case FRIEND_RES_TO_ADD_RESULT_CODE_EXCEED_NOT_EXIST_IN_WAITLIST:						// ��� ��Ͽ� �������� ����
			break;
		case FRIEND_RES_TO_ADD_RESULT_CODE_EXCEED_MAX_LIST_COUNT_BY_SELF:						// �ڽ��� ģ�� �ִ� ��� ���� �ʰ� 
			...
			pFriendPacket->Start();
			break;
		case FRIEND_RES_TO_ADD_RESULT_CODE_EXCEED_MAX_LIST_COUNT_BY_OTHER:						// ������ ģ�� �ִ� ��� ���� �ʰ�
