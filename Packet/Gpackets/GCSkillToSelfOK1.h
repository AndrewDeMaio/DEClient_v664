...
public :
	...
	// get packet id
	PacketID_t getPacketID() const { return PACKET_GC_SKILL_TO_SELF_OK_1; }
	
	// get packet's body size
	// ����ȭ��, �̸� ���� ������ ����Ѵ�.
	size_t getPacketSize() const { return szSkillType + szCEffectID + szDuration + szBYTE + ModifyInfo::getPacketSize() ; }
...
public :
	...
	// get packet id
	PacketID_t getPacketID() const { return Packet::PACKET_GC_SKILL_TO_SELF_OK_1; }
