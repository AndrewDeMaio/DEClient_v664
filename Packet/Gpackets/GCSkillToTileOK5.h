...
public :
	...
	// get packet id
	PacketID_t getPacketID() const { return PACKET_GC_SKILL_TO_TILE_OK_5; }
	
	// get packet's body size
	// ����ȭ��, �̸� ���� ������ ����Ѵ�.
	size_t getPacketSize() const { return szObjectID + szSkillType + szCoord*2+ szRange + szDuration + 
...
public :
	...
	// get packet id
	PacketID_t getPacketID() const { return Packet::PACKET_GC_SKILL_TO_TILE_OK_5; }
