...
//	"WEAPON_SWORD_SHIELD",
	...
	"WEAPON_OSIRIS_SR" ,		// ��
	"WEAPON_OSIRIS_AR" ,		// ��
	"WEAPON_OSIRIS_CROSS" ,	// ���ڰ�
	"WEAPON_OSIRIS_MACE" ,	// ���̽�
};
...
{ 
	...
	"VAMPIRE_COAT3" ,
	"VAMPIRE_COAT4" ,
	"VAMPIRE_OSIRIS_COAT" ,	//Day 2010.01.05, ID: shootkj 1�� ���� ���ø��� ����
	"VAMPIRE_COAT_MAX"
};
...
//////////////////////////////////////////////////////////////////////////////
// GearSlotID
#if __CONTENTS(__GEAR_SWAP_CHANGE)	// GearSlotID_t�� �ڷ��� ���� (typedef	ushort)
