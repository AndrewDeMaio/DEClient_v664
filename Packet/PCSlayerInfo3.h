...
public:
    ...
    enum SlayerBits {
		...
		SLAYER_BIT_HELMET1,
		SLAYER_BIT_HELMET2,
		SLAYER_BIT_HELMET_OSIRIS,
		SLAYER_BIT_JACKET1,
		SLAYER_BIT_JACKET2,
		SLAYER_BIT_JACKET3,
		SLAYER_BIT_JACKET_OSIRIS,
		SLAYER_BIT_PANTS1,
		SLAYER_BIT_PANTS2,
		SLAYER_BIT_PANTS3,
		SLAYER_BIT_PANTS_OSIRIS,
		SLAYER_BIT_WEAPON1,
		SLAYER_BIT_WEAPON2,
		SLAYER_BIT_WEAPON3,
		SLAYER_BIT_WEAPON4,
		SLAYER_BIT_WEAPON1_OSIRIS,
		SLAYER_BIT_WEAPON2_OSIRIS,
		SLAYER_BIT_WEAPON3_OSIRIS,
		SLAYER_BIT_WEAPON4_OSIRIS,
		SLAYER_BIT_SHIELD1,
		SLAYER_BIT_SHIELD2,
...
public:
	...
	const std::string& getName () const { Assert(m_Name != ""); return m_Name; }
...
public:
	...
	{ 
		m_Outlook &= ~bitset<SLAYER_BIT_MAX>(15 << SLAYER_BIT_JACKET1); 
		m_Outlook |= bitset<SLAYER_BIT_MAX>(jacketType << SLAYER_BIT_JACKET1); 
	}

	PantsType getPantsType () const 
	{ 
		return PantsType((m_Outlook.to_ulong() >> SLAYER_BIT_PANTS1) & 15); 
	}
	void setPantsType (PantsType pantsType)
	{ 
		m_Outlook &= ~bitset<SLAYER_BIT_MAX>(15 << SLAYER_BIT_PANTS1); 
...
#if __CONTENTS(__FAST_TRANSFORTER||__SECOND_TRANSFORTER)
	Color_t getMotorcycleEffectColor (ColorType colorType = MAIN_COLOR) const 
	{ 
		return m_Colors[ SLAYER_COLOR_MOTORCYCLE_EFFECT + (uint)colorType ]; 
	}
	void setMotorcycleEffectColor (Color_t color, ColorType colorType = MAIN_COLOR) 
	{ 
