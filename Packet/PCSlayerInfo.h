...
public:
	...
	{ 
		m_Outlook &= ~std::bitset<SLAYER_BIT_MAX>(15 << SLAYER_BIT_JACKET1); 
	...
	{ 
		m_Outlook &= ~std::bitset<SLAYER_BIT_MAX>(15 << SLAYER_BIT_PANTS1);
	...
	{ 
		m_Outlook &= ~std::bitset<SLAYER_BIT_MAX>(255 << SLAYER_BIT_WEAPON1); 
	...
	{ 
		m_Outlook &= ~std::bitset<SLAYER_BIT_MAX>(7 << SLAYER_BIT_SHIELD1); 
