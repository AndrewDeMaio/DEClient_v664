...
//  Packet_PCH.h
//
//  Precompiled prelude for the Packet static library.
//
//  KEEP THIS IN SYNC WITH UI\header\Client_PCH.h.
//  Both must pull in ContentsFilter.h, because that header (combined with the
//  design macro set in Build\DEClient.Common.props) decides which members the
//  packet structs have and what getPacketSize() returns. If Packet.lib and
//  UI.exe disagree, the result is silent memory corruption at runtime, not a
