...
//----------------------------------------------------------------------
bool
CTexturePack::InitPart(CShadowSpriteTypePack& SSPK, TYPE_SPRITEID firstShadowSpriteID, TYPE_SPRITEID lastShadowSpriteID)
{
	//--------------------------------------------
	...
	*/
	...
	//---------------------------------------------
	for (size_t sur = firstShadowSpriteID; sur < lastShadowSpriteID; sur++)
	{
		//---------------------------------------------------
		// Video Memory 남은거 보기
		//---------------------------------------------------
